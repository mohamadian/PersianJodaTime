...
public class PersianDateTimeUtils {

    /** The singleton instance of the system millisecond provider. */
    private static final PersianDateTimeUtils.SystemMillisProvider SYSTEM_MILLIS_PROVIDER = new PersianDateTimeUtils.SystemMillisProvider();
    /** The millisecond provider currently in use. */
    private static volatile DateTimeUtils.MillisProvider cMillisProvider = SYSTEM_MILLIS_PROVIDER;
    /** The millisecond provider currently in use. */
     ...
     */
    protected PersianDateTimeUtils() {
        super();
    }
    ...
    public static final void setCurrentMillisFixed(long fixedMillis) throws SecurityException {
        checkPermission();
        cMillisProvider = new PersianDateTimeUtils.FixedMillisProvider(fixedMillis);
    }
    ...
    public static final void setCurrentMillisOffset(long offsetMillis) throws SecurityException {
        ...
        if (offsetMillis == 0) {
            ...
            cMillisProvider = new PersianDateTimeUtils.OffsetMillisProvider(offsetMillis);
        }
    }
     ...
     */
    static class FixedMillisProvider implements DateTimeUtils.MillisProvider {
     ...
     */
    static class OffsetMillisProvider implements DateTimeUtils.MillisProvider {
        /** The millis offset. */
        private final long iMillis;
